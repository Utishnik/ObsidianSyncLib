...
fn count_syms_b_str(str: &String, syms: String) -> Result<u64, ()> {
    if str.is_empty() || syms.is_empty() {
        debug::debug_and_test_utils::set_color_eprint(debug::debug_and_test_utils::Colors::Blue);
        debug_eprintln!("--------------------------------------");
        debug::debug_and_test_utils::reset_color_eprint();
        debug::debug_and_test_utils::set_color_eprint(debug::debug_and_test_utils::Colors::Red);
        if str.is_empty() {
...
pub fn splitt_b_space(
    ...
    if str.is_empty() {
        debug::debug_and_test_utils::set_color_print(debug::debug_and_test_utils::Colors::Red);
        debug_eprintln!("splitt_b_space str is_empty");
        debug::debug_and_test_utils::reset_color_print();
    ...
    if let Ok(cnt) = count_syms_b_str(
        ...
        for c in str.chars()
        {
            ...
            debug::debug_and_test_utils::set_color_print(debug::debug_and_test_utils::Colors::Blue);

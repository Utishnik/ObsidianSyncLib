...
use super::debug::debug_and_test_utils::clear_console;
...
impl Pos {
    ...
    pub fn conver_to_pos(idx: usize, cfg: &str, transfers: Option<String>) -> Result<Pos, ()> {
        ...
        if transfers == None {
            ...
            set_color_print(super::debug::debug_and_test_utils::Colors::Blue);
            debug_println!(
        ...
        let mut it: usize = 0;
        if let Err(err) = ret_res {
            set_color_eprint(super::debug::debug_and_test_utils::Colors::Yellow);
...
impl AbstractValue for String {
    ...
    fn parse_value(str: &str, index: &mut usize) -> Result<String, ParseExprError> {
        ...
        loop {
            ...
            set_color_print(super::debug::debug_and_test_utils::Colors::Green);
